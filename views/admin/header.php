...
<head>
    ...
    <title>Clothing Sales - Board</title>
    ...
    <div class="wrapper">
        <nav id="sidebar" class="active">
            <ul class="list-unstyled components text-secondary">
                <li>
                    <a href="/admin/home"><i class="fas fa-home"></i>Inicio</a>
                </li>
                <li>
                    <a href="/admin/products"><i class="fas fa-shopping-cart"></i>Productos</a>
                </li>
                <li>
                    <a href="/admin/customers"><i class="fas fa-user"></i></i>Clientes</a>
                </li>
                <li>
                    <a href="/admin/orders"><i class="fas fa-file"></i>Movimientos</a>
                </li>
                        ...
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end nav-link-menu">
                                    <ul class="nav-list">
                                        <li><a href="/admin/reset-password" class="dropdown-item"><i class="fas fa-address-card"></i>Reiniciar contraseña</a></li>
                                        <li><a href="/admin/logout" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Salir</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
