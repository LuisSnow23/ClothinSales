                ...
                <div class="tab-pane fade" id="system" role="tabpanel" aria-labelledby="system-tab">
                    <div class="col-md-6">
                        <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                            ...
                            <div class="mb-3 text-end">
                                <button class="btn btn-success" name="contact-submit" type="submit"><i class="fas fa-check"></i>Actualizar</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="tab-pane fade" id="attributions" role="tabpanel" aria-labelledby="attributions-tab">
                    <h4 class="mb-0">Informacion legal</h4>
                    <p class="text-muted">Copyright (c) <script>document.write(new Date().getFullYear());</script>Clothing Sales - Todos los derechos reservados.</p>
                    <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                        <?php CSRF::csrfInputField() ?>
                        <textarea class="form-control" name="policy" style="resize:none" required rows="20"><?= $privacyPolicy[0]['policy'] ?></textarea>            
                        <div class="mb-3 text-end">
                            <button class="btn btn-success" name="policy-submit" type="submit"><i class="fas fa-check"></i> Actualizar</button>
                        </div>
                    </form>
                </div>
            </div>
