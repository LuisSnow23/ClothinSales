...
<head>
    ...
    <title>Clothing Sales - Admin</title>
        ...
        <div class="auth-content">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <?php endif ?>
                    <h6 class="mb-4 text-muted">INGRESA LA CUENTA DE ADMINISTRADOR</h6>
                    <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="post">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary shadow-2 mb-4">Entrar</button>
                    </form>
                </div>
            </div>
        </div>
