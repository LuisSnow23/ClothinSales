...
<div class="container">
    <div class="page-title">
        <h3>Clientes
        <a href="/admin/customers/create" class="btn btn-sm btn-outline-primary float-end"><i class="fas fa-plus"></i> Agregar</a>
        </h3>
    </div>
    <?php if($edit): ?>
        <div class="card">
            ...
            <div class="card-body">
                <form accept-charset="utf-8" method="post" action="/admin/customers">
                    ...
                    <button name="submit" type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Guardar</button>
                </form>
            </div>
        </div>
    <?php else: ?>
